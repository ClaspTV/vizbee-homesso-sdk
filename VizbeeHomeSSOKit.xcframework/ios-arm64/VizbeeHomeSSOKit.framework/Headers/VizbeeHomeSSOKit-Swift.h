...
#ifndef VIZBEEHOMESSOKIT_SWIFT_H
#define VIZBEEHOMESSOKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VizbeeHomeSSOKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Protocol for handling HomeSSO adapter methods.
...
/// \param successCallback A callback through which the app informs the SDK about its sign-in status.
///
/// \param failureCallback A callback invoked in case of failure.
///
- (void)getSignedInInfoOnSuccess:(void (^ _Nonnull)(NSArray<VZBSignInInfo *> * _Nonnull))successCallback onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureCallback;
